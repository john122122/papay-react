      ...
      <Container>
        ...
        <Stack className="parts">
          ...
          <Box className="target">
           ...
           <Stack className="phone" sx={{mt: "42px"}}>
              <Box className="detail_first">P.</Box>
              <Box className="detail_three">+998 - 99  266  25  62</Box>
           </Stack>
           <Stack className="email" sx={{mt: "9px"}}>
              <Box className="detail_first">E.</Box> 
              <Box className="detail_four">Papays@restaurant.com</Box>
           </Stack>
        </Stack>
    </Stack>
